...
test('CAG should union properly', t => {
  ...
  t.deepEqual(compareCagSide(firstSide), {pos: [[2, 0], [2, 2]]})
  compareCagSides(t, compareCagSide(lastSide), {pos: [[0, 0.8506508083520399], [-0.8090169943749475, 0.5877852522924732]]}, 0.000001)
  // t.deepEqual(compareCagSide(lastSide), {pos: [[0, 0.8506508083520399], [-0.8090169943749475, 0.5877852522924732]]})
...
test('CAG should subtract properly', t => {
  ...
  t.deepEqual(compareCagSide(firstSide), {pos: [[-3, 3], [-3, -3]]})
  t.deepEqual(compareCagSide(lastSide), {pos: [[0.30901699437494723, -0.9510565162951536], [-0.8090169943749475, -0.587785252292473]]})
})
...
test('CAG should intersect properly', t => {
  ...
  t.deepEqual(compareCagSide(firstSide), {pos: [[0.30901699437494723, -0.9510565162951536], [1, 0]]})
  t.deepEqual(compareCagSide(lastSide), {pos: [[-0.8090169943749475, -0.587785252292473], [0.30901699437494723, -0.9510565162951536]]})
})
...
test('CAG should transform properly', t => {
  ...
  t.deepEqual(compareCagSide(res1.sides[0]), {pos: [[7, 13], [7, 7]]})
  t.deepEqual(compareCagSide(res1.sides[1]), {pos: [[7, 7], [13, 7]]})
  t.deepEqual(compareCagSide(res1.sides[2]), {pos: [[13, 7], [13, 13]]})
  t.deepEqual(compareCagSide(res1.sides[3]), {pos: [[13, 13], [7, 13]]})
})

test('CAG should flip properly', t => {
  const cag1 = CAG.rectangle({center: [5,-5],radius: [3,2]})
  let res1 = cag1.flipped()
  t.deepEqual(compareCagSide(res1.sides[0]), {pos: [[2, -3], [8, -3]]})
  t.deepEqual(compareCagSide(res1.sides[1]), {pos: [[8, -3], [8, -7]]})
  t.deepEqual(compareCagSide(res1.sides[2]), {pos: [[8, -7], [2, -7]]})
  t.deepEqual(compareCagSide(res1.sides[3]), {pos: [[2, -7], [2, -3]]})
})
...
// FIX ME order of sides is just WRONG!!!!
  t.deepEqual(compareCagSide(res1.sides[0]), {pos: [[11, -8], [11, -2]]})
  t.deepEqual(compareCagSide(res1.sides[1]), {pos: [[11, -2], [10, -1]]})
  t.deepEqual(compareCagSide(res1.sides[2]), {pos: [[10, -1], [0, -1]]})
  t.deepEqual(compareCagSide(res1.sides[3]), {pos: [[0, -1], [-1, -2]]})
})
...
//console.log(res1.toString())
// FIX ME order of sides is just WRONG!!!!
  t.deepEqual(compareCagSide(res1.sides[0]), {pos: [[9, -7], [9, -3]]})
  t.deepEqual(compareCagSide(res1.sides[1]), {pos: [[9, -3], [8, -2]]})
  t.deepEqual(compareCagSide(res1.sides[2]), {pos: [[8, -2], [2, -2]]})
  t.deepEqual(compareCagSide(res1.sides[3]), {pos: [[2, -2], [1, -3]]})
})
