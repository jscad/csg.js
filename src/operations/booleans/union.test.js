...
test('union: union of one or more geom2 objects produces expected geometry', t => {
...
test('union: union of one or more geom3 objects produces expected geometry', t => {
  ...
  exp = [
    ...
    [[9, 8, -9], [9, 9, -9], [9, 9, 8], [9, 8, 8]],
    [[9, 9, 8], [9, 9, -9], [8, 9, -9], [8, 9, 8]],
    [[8, -9, 9], [9, -9, 9], [9, 8, 9], [8, 8, 9]]
  ]
  t.is(obs.length, 18)
  t.true(comparePolygonsAsPoints(obs, exp))
