...
function cubeFn (params) {
  ...
  let object = round
    ? roundedCube({radius: [x / 2, y / 2, z / 2], roundradius: radius, resolution: fn})
...
function sphereFn (params) {
  ...
  let output = type === 'geodesic' ? geodesicSphere(params) : sphere({radius: r, resolution: fn})
...
function cylinderFn (params) {
  ...
  if (params && (params.start && params.end)) {
    object = round
      ? roundedCylinder({start: params.start, end: params.end, radiusStart: r1, radiusEnd: r2, resolution: fn})
      : cylinder({start: params.start, end: params.end, radiusStart: r1, radiusEnd: r2, resolution: fn})
  } else {
    object = round
      ? roundedCylinder({start: [0, 0, 0], end: [0, 0, h], radiusStart: r1, radiusEnd: r2, resolution: fn})
      : cylinder({start: [0, 0, 0], end: [0, 0, h], radiusStart: r1, radiusEnd: r2, resolution: fn})
    let r = r1 > r2 ? r1 : r2
