...
test.only('vec3: multiply() called with two paramerters should return a vec3 with correct values', t => {
...
test.only('vec3: multiply() called with three paramerters should update a vec3 with correct values', t => {
